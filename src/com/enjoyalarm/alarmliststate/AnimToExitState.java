...
public class AnimToExitState extends State {
	 ...
	 */
	public AnimToExitState(ViewControlInterface controlInterface,
	...
	private void changeToExitStateToHandle() {
		mControlInterface.exitApp();
	}

	private class AnimThread extends Thread {
		@Override
		public void run() {
			float velocity = Math.abs(mPositionX) / 64;
			float gap = mViewWidth * 0.005f;
			float limit = mViewWidth * 0.96f;
